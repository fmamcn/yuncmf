		...
		if (is_array($child)) {
			if(count($child)>10){
				foreach ($child as $id => $a) {
					...
					$this->str .= $recursion ? "<ul class='$ul_class submenua'><li  $class_str id= 'menu-item-$id'>" : "<li  $class_str   id= 'menu-item-$id'>";
					$recursion = FALSE;
					//判断是否含有子菜单
